...
/*
 * \file /github/workspace/ci/generation/neon/src/test/compare_unit_test.cpp
 * \date 2024-03-08
...
TEST_CASE("Testing primitive 'count_matches' for neon", "[count_matches],[neon]") {
    using namespace tsl;
    SECTION("with_only_zero_searching_one") {
        WARN("Primitive count_matches not implemented for neon");
    }
    SECTION("with_only_zero_searching_zero") {
        WARN("Primitive count_matches not implemented for neon");
    }
...
TEST_CASE("Testing primitive 'unequal_zero' for neon", "[unequal_zero],[neon]") {
    using namespace tsl;
    SECTION("with_only_one") {
        WARN("Primitive unequal_zero not implemented for neon");
    }
    SECTION("with_only_zero") {
        WARN("Primitive unequal_zero not implemented for neon");
    }
...
TEST_CASE("Testing primitive 'between_inclusive' for neon", "[between_inclusive],[neon]") {
    using namespace tsl;
    SECTION("check_boundaries") {
...
TEST_CASE("Testing primitive 'equal' for neon", "[equal],[neon]") {
    using namespace tsl;
    SECTION("all_equal") {
...
TEST_CASE("Testing primitive 'greater_than' for neon", "[greater_than],[neon]") {
    using namespace tsl;
    SECTION("default") {
        WARN("Can't run. Required primitive(s) ['to_mask<int8_t,neon>'] not provided.");
        WARN("Can't run. Required primitive(s) ['to_mask<uint8_t,neon>'] not provided.");
...
TEST_CASE("Testing primitive 'greater_than_or_equal' for neon", "[greater_than_or_equal],[neon]") {
    using namespace tsl;
    SECTION("default") {
        WARN("Can't run. Required primitive(s) ['to_mask<int8_t,neon>'] not provided.");
        WARN("Can't run. Required primitive(s) ['to_mask<uint8_t,neon>'] not provided.");
...
TEST_CASE("Testing primitive 'less_than' for neon", "[less_than],[neon]") {
    using namespace tsl;
    SECTION("default") {
        WARN("Can't run. Required primitive(s) ['to_mask<int8_t,neon>'] not provided.");
        WARN("Can't run. Required primitive(s) ['to_mask<uint8_t,neon>'] not provided.");
...
TEST_CASE("Testing primitive 'less_than_or_equal' for neon", "[less_than_or_equal],[neon]") {
    using namespace tsl;
    SECTION("default") {
        WARN("Can't run. Required primitive(s) ['to_mask<int8_t,neon>'] not provided.");
        WARN("Can't run. Required primitive(s) ['to_mask<uint8_t,neon>'] not provided.");
...
TEST_CASE("Testing primitive 'mask_equal' for neon", "[mask_equal],[neon]") {
    using namespace tsl;
    SECTION("all_equal") {
        WARN("Primitive mask_equal not implemented for neon");
    }
    SECTION("all_unequal") {
        WARN("Primitive mask_equal not implemented for neon");
    }
...
TEST_CASE("Testing primitive 'nequal' for neon", "[nequal],[neon]") {
    using namespace tsl;
    SECTION("all_equal") {
        WARN("Primitive nequal not implemented for neon");
    }
    SECTION("all_unequal") {
        WARN("Primitive nequal not implemented for neon");
    }
