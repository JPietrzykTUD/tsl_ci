 ...
 *==========================================================================*/
/*
 * \file /github/workspace/ci/generation/neon/include/generated/definitions/compare/compare_neon.hpp
 * \date 2024-03-08
 ...
 *
 */
#ifndef TUD_D2RG_TSL_GITHUB_WORKSPACE_CI_GENERATION_NEON_INCLUDE_GENERATED_DEFINITIONS_COMPARE_COMPARE_NEON_HPP
#define TUD_D2RG_TSL_GITHUB_WORKSPACE_CI_GENERATION_NEON_INCLUDE_GENERATED_DEFINITIONS_COMPARE_COMPARE_NEON_HPP
...
namespace tsl {
    ...
    namespace functors {
         ...
         *      Yaml Source: primitive_data/primitives/compare.yaml::132
         */
    ...
    namespace functors {
         ...
         *        Data Type: int8_t
         *  Extension Flags: ['neon']
         *      Yaml Source: primitive_data/primitives/compare.yaml::732
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: int8_t
         *  Extension Flags: ['neon']
         *      Yaml Source: primitive_data/primitives/compare.yaml::934
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: int8_t
         *  Extension Flags: ['neon']
         *      Yaml Source: primitive_data/primitives/compare.yaml::1144
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: int8_t
         *  Extension Flags: ['neon']
         *      Yaml Source: primitive_data/primitives/compare.yaml::1367
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: int64_t
         *  Extension Flags: ['neon']
         *      Yaml Source: primitive_data/primitives/compare.yaml::1560
         */
        template<ImplementationDegreeOfFreedom Idof>
...
#endif //TUD_D2RG_TSL_GITHUB_WORKSPACE_CI_GENERATION_NEON_INCLUDE_GENERATED_DEFINITIONS_COMPARE_COMPARE_NEON_HPP