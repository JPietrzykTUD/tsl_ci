 ...
 *==========================================================================*/
/*
 * \file /home/jpietrzyk/tmp/TSL_ACTIONS/tsl_ci/generated_tsl/include/generated/declarations/misc.hpp
 * \date 2024-02-28
 ...
 *
 */
#ifndef TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_GENERATED_TSL_INCLUDE_GENERATED_DECLARATIONS_MISC_HPP
#define TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_GENERATED_TSL_INCLUDE_GENERATED_DECLARATIONS_MISC_HPP
...
namespace tsl {
    ...
    template<
        ...
        ImplementationDegreeOfFreedom Idof = workaround
    >
    [[nodiscard]] TSL_FORCE_INLINE auto undefined(
        
    ) -> std::enable_if_t<
      tsl_functor_defined<functors::undefined<Vec, Idof>>::value,
      typename Vec::register_type
    >{
    ...
    [[nodiscard]] TSL_FORCE_INLINE auto maskz_mov(
      ...
      tsl_functor_defined<functors::maskz_mov<Vec, Idof>>::value,
      typename Vec::register_type
    >{
...
#endif //TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_GENERATED_TSL_INCLUDE_GENERATED_DECLARATIONS_MISC_HPP