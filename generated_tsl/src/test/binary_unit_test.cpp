...
/*
 * \file /home/jpietrzyk/tmp/TSL_ACTIONS/tsl_ci/generated_tsl/src/test/binary_unit_test.cpp
 * \date 2024-02-28
...
TEST_CASE("Testing primitive 'lzc' for avx2", "[lzc],[avx2]") {
    using namespace tsl;
    SECTION("test_msb") {
        WARN("Primitive lzc<simd<double, avx2>> not implemented.");
        WARN("Primitive lzc<simd<float, avx2>> not implemented.");
        CHECK(test_lzc_test_msb<simd<int16_t, avx2>>());

        CHECK(test_lzc_test_msb<simd<int32_t, avx2>>());

        CHECK(test_lzc_test_msb<simd<int64_t, avx2>>());

        CHECK(test_lzc_test_msb<simd<int8_t, avx2>>());

        CHECK(test_lzc_test_msb<simd<uint16_t, avx2>>());

        CHECK(test_lzc_test_msb<simd<uint32_t, avx2>>());

        CHECK(test_lzc_test_msb<simd<uint64_t, avx2>>());

        CHECK(test_lzc_test_msb<simd<uint8_t, avx2>>());

    }
    SECTION("test_one") {
        WARN("Primitive lzc<simd<double, avx2>> not implemented.");
        WARN("Primitive lzc<simd<float, avx2>> not implemented.");
        CHECK(test_lzc_test_one<simd<int16_t, avx2>>());

        CHECK(test_lzc_test_one<simd<int32_t, avx2>>());

        CHECK(test_lzc_test_one<simd<int64_t, avx2>>());

        CHECK(test_lzc_test_one<simd<int8_t, avx2>>());

        CHECK(test_lzc_test_one<simd<uint16_t, avx2>>());

        CHECK(test_lzc_test_one<simd<uint32_t, avx2>>());

        CHECK(test_lzc_test_one<simd<uint64_t, avx2>>());

        CHECK(test_lzc_test_one<simd<uint8_t, avx2>>());

    }
    SECTION("test_zero") {
        WARN("Primitive lzc<simd<double, avx2>> not implemented.");
        WARN("Primitive lzc<simd<float, avx2>> not implemented.");
        CHECK(test_lzc_test_zero<simd<int16_t, avx2>>());

        CHECK(test_lzc_test_zero<simd<int32_t, avx2>>());

        CHECK(test_lzc_test_zero<simd<int64_t, avx2>>());

        CHECK(test_lzc_test_zero<simd<int8_t, avx2>>());

        CHECK(test_lzc_test_zero<simd<uint16_t, avx2>>());

        CHECK(test_lzc_test_zero<simd<uint32_t, avx2>>());

        CHECK(test_lzc_test_zero<simd<uint64_t, avx2>>());

        CHECK(test_lzc_test_zero<simd<uint8_t, avx2>>());
...
TEST_CASE("Testing primitive 'binary_or' for avx2", "[binary_or],[avx2]") {
    ...
    SECTION("default") {
        ...
        WARN("Primitive binary_or<simd<int16_t, avx2>> not implemented.");
        WARN("Primitive binary_or<simd<int32_t, avx2>> not implemented.");
        WARN("Primitive binary_or<simd<int64_t, avx2>> not implemented.");
        WARN("Primitive binary_or<simd<int8_t, avx2>> not implemented.");
        WARN("Primitive binary_or<simd<uint16_t, avx2>> not implemented.");
        WARN("Primitive binary_or<simd<uint32_t, avx2>> not implemented.");
        WARN("Primitive binary_or<simd<uint64_t, avx2>> not implemented.");
        WARN("Primitive binary_or<simd<uint8_t, avx2>> not implemented.");
    }
}
...
TEST_CASE("Testing primitive 'hor' for avx2", "[hor],[avx2]") {
    using namespace tsl;
    SECTION("with_only_one") {
        WARN("Primitive hor not implemented for avx2");
    }
    SECTION("with_only_zero") {
        WARN("Primitive hor not implemented for avx2");
    }
...
TEST_CASE("Testing primitive 'inv' for avx2", "[inv],[avx2]") {
    using namespace tsl;
    SECTION("with_only_ones") {
        WARN("Primitive inv not implemented for avx2");
    }
    SECTION("with_only_zero") {
        WARN("Primitive inv not implemented for avx2");
    }
...
TEST_CASE("Testing primitive 'shift_left' for avx2", "[shift_left],[avx2]") {
    using namespace tsl;
    SECTION("default") {
        WARN("Primitive shift_left not implemented for avx2");
    }
}
...
TEST_CASE("Testing primitive 'shift_left_vector' for avx2", "[shift_left_vector],[avx2]") {
    using namespace tsl;
    SECTION("default") {
        WARN("Primitive shift_left_vector not implemented for avx2");
    }
}
...
TEST_CASE("Testing primitive 'shift_right' for avx2", "[shift_right],[avx2]") {
    using namespace tsl;
    SECTION("shift_right_arithmetic") {
        WARN("Primitive shift_right not implemented for avx2");
    }
    SECTION("shift_right_ignore_sign") {
        WARN("Primitive shift_right not implemented for avx2");
    }
...
TEST_CASE("Testing primitive 'shift_right_vector' for avx2", "[shift_right_vector],[avx2]") {
    using namespace tsl;
    SECTION("shift_right_arithmetic") {
        WARN("Primitive shift_right_vector not implemented for avx2");
    }
    SECTION("shift_right_ignore_sign") {
        WARN("Primitive shift_right_vector not implemented for avx2");
    }
