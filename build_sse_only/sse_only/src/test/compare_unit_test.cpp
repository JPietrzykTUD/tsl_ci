...
/*
 * \file /home/jpietrzyk/tmp/TSL_ACTIONS/tsl_ci/sse_only/src/test/compare_unit_test.cpp
 * \date 2024-02-29
...
TEST_CASE("Testing primitive 'count_matches' for sse", "[count_matches],[sse]") {
    using namespace tsl;
    SECTION("with_only_zero_searching_one") {
        WARN("Primitive count_matches<simd<double, sse>> not implemented.");
        WARN("Primitive count_matches<simd<float, sse>> not implemented.");
        WARN("Primitive count_matches<simd<int16_t, sse>> not implemented.");
        WARN("Primitive count_matches<simd<int32_t, sse>> not implemented.");
        WARN("Primitive count_matches<simd<int64_t, sse>> not implemented.");
        CHECK(test_count_matches_with_only_zero_searching_one<simd<int8_t, sse>>());

        WARN("Primitive count_matches<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive count_matches<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive count_matches<simd<uint64_t, sse>> not implemented.");
...
TEST_CASE("Testing primitive 'unequal_zero' for sse", "[unequal_zero],[sse]") {
    ...
    SECTION("with_only_one") {
        ...
        WARN("Primitive unequal_zero<simd<int16_t, sse>> not implemented.");
        WARN("Primitive unequal_zero<simd<int32_t, sse>> not implemented.");
        WARN("Primitive unequal_zero<simd<int64_t, sse>> not implemented.");
        WARN("Primitive unequal_zero<simd<int8_t, sse>> not implemented.");
        WARN("Primitive unequal_zero<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive unequal_zero<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive unequal_zero<simd<uint64_t, sse>> not implemented.");
        WARN("Primitive unequal_zero<simd<uint8_t, sse>> not implemented.");
    }
    SECTION("with_only_zero") {
...
TEST_CASE("Testing primitive 'between_inclusive' for sse", "[between_inclusive],[sse]") {
    using namespace tsl;
    SECTION("check_boundaries") {
        CHECK(test_between_inclusive_check_boundaries<simd<double, sse>>());

        CHECK(test_between_inclusive_check_boundaries<simd<float, sse>>());

        WARN("Primitive between_inclusive<simd<int16_t, sse>> not implemented.");
        WARN("Primitive between_inclusive<simd<int32_t, sse>> not implemented.");
        WARN("Primitive between_inclusive<simd<int64_t, sse>> not implemented.");
        WARN("Primitive between_inclusive<simd<int8_t, sse>> not implemented.");
        WARN("Primitive between_inclusive<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive between_inclusive<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive between_inclusive<simd<uint64_t, sse>> not implemented.");
        WARN("Primitive between_inclusive<simd<uint8_t, sse>> not implemented.");
    }
    SECTION("complete_range") {
        CHECK(test_between_inclusive_complete_range<simd<double, sse>>());

        CHECK(test_between_inclusive_complete_range<simd<float, sse>>());
    ...
    SECTION("not_in_range") {
        CHECK(test_between_inclusive_not_in_range<simd<double, sse>>());

        CHECK(test_between_inclusive_not_in_range<simd<float, sse>>());
...
TEST_CASE("Testing primitive 'equal' for sse", "[equal],[sse]") {
    using namespace tsl;
    SECTION("all_equal") {
        CHECK(test_equal_all_equal<simd<double, sse>>());

        CHECK(test_equal_all_equal<simd<float, sse>>());

        CHECK(test_equal_all_equal<simd<int16_t, sse>>());

        CHECK(test_equal_all_equal<simd<int32_t, sse>>());

        WARN("Primitive equal<simd<int64_t, sse>> not implemented.");
        ...
        WARN("Primitive equal<simd<uint64_t, sse>> not implemented.");
        CHECK(test_equal_all_equal<simd<uint8_t, sse>>());

    }
    SECTION("none_equal") {
        CHECK(test_equal_none_equal<simd<double, sse>>());

        CHECK(test_equal_none_equal<simd<float, sse>>());
...
TEST_CASE("Testing primitive 'greater_than' for sse", "[greater_than],[sse]") {
    ...
    SECTION("default") {
        ...
        WARN("Primitive greater_than<simd<int64_t, sse>> not implemented.");
        CHECK(test_greater_than_default<simd<int8_t, sse>>());

        WARN("Primitive greater_than<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive greater_than<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive greater_than<simd<uint64_t, sse>> not implemented.");
        WARN("Primitive greater_than<simd<uint8_t, sse>> not implemented.");
    }
    SECTION("equal") {
...
TEST_CASE("Testing primitive 'greater_than_or_equal' for sse", "[greater_than_or_equal],[sse]") {
    ...
    SECTION("default") {
        ...
        WARN("Primitive greater_than_or_equal<simd<int64_t, sse>> not implemented.");
        CHECK(test_greater_than_or_equal_default<simd<int8_t, sse>>());

        WARN("Primitive greater_than_or_equal<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive greater_than_or_equal<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive greater_than_or_equal<simd<uint64_t, sse>> not implemented.");
        WARN("Primitive greater_than_or_equal<simd<uint8_t, sse>> not implemented.");
    }
    SECTION("equal") {
...
TEST_CASE("Testing primitive 'less_than' for sse", "[less_than],[sse]") {
    ...
    SECTION("default") {
        ...
        WARN("Primitive less_than<simd<int64_t, sse>> not implemented.");
        CHECK(test_less_than_default<simd<int8_t, sse>>());

        WARN("Primitive less_than<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive less_than<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive less_than<simd<uint64_t, sse>> not implemented.");
        WARN("Primitive less_than<simd<uint8_t, sse>> not implemented.");
    }
    SECTION("equal") {
...
TEST_CASE("Testing primitive 'less_than_or_equal' for sse", "[less_than_or_equal],[sse]") {
    ...
    SECTION("default") {
        ...
        WARN("Primitive less_than_or_equal<simd<int64_t, sse>> not implemented.");
        CHECK(test_less_than_or_equal_default<simd<int8_t, sse>>());

        WARN("Primitive less_than_or_equal<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive less_than_or_equal<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive less_than_or_equal<simd<uint64_t, sse>> not implemented.");
        WARN("Primitive less_than_or_equal<simd<uint8_t, sse>> not implemented.");
    }
    SECTION("equal") {
...
TEST_CASE("Testing primitive 'mask_equal' for sse", "[mask_equal],[sse]") {
    using namespace tsl;
    SECTION("all_equal") {
        CHECK(test_mask_equal_all_equal<simd<double, sse>>());

        CHECK(test_mask_equal_all_equal<simd<float, sse>>());

        CHECK(test_mask_equal_all_equal<simd<int16_t, sse>>());

        CHECK(test_mask_equal_all_equal<simd<int32_t, sse>>());

        WARN("Can't run. Required primitive(s) ['equal<int64_t,sse>'] not provided.");
        CHECK(test_mask_equal_all_equal<simd<int8_t, sse>>());

        CHECK(test_mask_equal_all_equal<simd<uint16_t, sse>>());

        CHECK(test_mask_equal_all_equal<simd<uint32_t, sse>>());

        WARN("Can't run. Required primitive(s) ['equal<uint64_t,sse>'] not provided.");
        CHECK(test_mask_equal_all_equal<simd<uint8_t, sse>>());

    }
    SECTION("all_unequal") {
        CHECK(test_mask_equal_all_unequal<simd<double, sse>>());

        CHECK(test_mask_equal_all_unequal<simd<float, sse>>());

        CHECK(test_mask_equal_all_unequal<simd<int16_t, sse>>());

        CHECK(test_mask_equal_all_unequal<simd<int32_t, sse>>());

        WARN("Can't run. Required primitive(s) ['equal<int64_t,sse>'] not provided.");
        CHECK(test_mask_equal_all_unequal<simd<int8_t, sse>>());

        CHECK(test_mask_equal_all_unequal<simd<uint16_t, sse>>());

        CHECK(test_mask_equal_all_unequal<simd<uint32_t, sse>>());

        WARN("Can't run. Required primitive(s) ['equal<uint64_t,sse>'] not provided.");
        CHECK(test_mask_equal_all_unequal<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'nequal' for sse", "[nequal],[sse]") {
    using namespace tsl;
    SECTION("all_equal") {
        WARN("Primitive nequal<simd<double, sse>> not implemented.");
        WARN("Primitive nequal<simd<float, sse>> not implemented.");
        CHECK(test_nequal_all_equal<simd<int16_t, sse>>());

        CHECK(test_nequal_all_equal<simd<int32_t, sse>>());

        WARN("Primitive nequal<simd<int64_t, sse>> not implemented.");
        CHECK(test_nequal_all_equal<simd<int8_t, sse>>());

        CHECK(test_nequal_all_equal<simd<uint16_t, sse>>());

        CHECK(test_nequal_all_equal<simd<uint32_t, sse>>());

        WARN("Primitive nequal<simd<uint64_t, sse>> not implemented.");
        CHECK(test_nequal_all_equal<simd<uint8_t, sse>>());

    }
    SECTION("all_unequal") {
        WARN("Primitive nequal<simd<double, sse>> not implemented.");
        WARN("Primitive nequal<simd<float, sse>> not implemented.");
        CHECK(test_nequal_all_unequal<simd<int16_t, sse>>());

        CHECK(test_nequal_all_unequal<simd<int32_t, sse>>());

        WARN("Primitive nequal<simd<int64_t, sse>> not implemented.");
        CHECK(test_nequal_all_unequal<simd<int8_t, sse>>());

        CHECK(test_nequal_all_unequal<simd<uint16_t, sse>>());

        CHECK(test_nequal_all_unequal<simd<uint32_t, sse>>());

        WARN("Primitive nequal<simd<uint64_t, sse>> not implemented.");
        CHECK(test_nequal_all_unequal<simd<uint8_t, sse>>());
