...
/*
 * \file /home/jpietrzyk/tmp/TSL_ACTIONS/tsl_ci/sse_only/src/test/calc_unit_test.cpp
 * \date 2024-02-29
...
TEST_CASE("Testing primitive 'mod_constant' for sse", "[mod_constant],[sse]") {
    using namespace tsl;
    SECTION("with_check_barrett_reduction_constraint") {
        WARN("Primitive mod_constant<simd<double, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<float, sse>> not implemented.");
        CHECK(test_mod_constant_with_check_barrett_reduction_constraint<simd<int16_t, sse>>());

        WARN("Primitive mod_constant<simd<int32_t, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<int64_t, sse>> not implemented.");
        CHECK(test_mod_constant_with_check_barrett_reduction_constraint<simd<int8_t, sse>>());

        CHECK(test_mod_constant_with_check_barrett_reduction_constraint<simd<uint16_t, sse>>());

        WARN("Primitive mod_constant<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<uint64_t, sse>> not implemented.");
        CHECK(test_mod_constant_with_check_barrett_reduction_constraint<simd<uint8_t, sse>>());

    }
    SECTION("with_modulo_one") {
        WARN("Primitive mod_constant<simd<double, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<float, sse>> not implemented.");
        CHECK(test_mod_constant_with_modulo_one<simd<int16_t, sse>>());

        WARN("Primitive mod_constant<simd<int32_t, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<int64_t, sse>> not implemented.");
        CHECK(test_mod_constant_with_modulo_one<simd<int8_t, sse>>());

        CHECK(test_mod_constant_with_modulo_one<simd<uint16_t, sse>>());

        WARN("Primitive mod_constant<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<uint64_t, sse>> not implemented.");
        CHECK(test_mod_constant_with_modulo_one<simd<uint8_t, sse>>());

    }
    SECTION("with_modulo_rand") {
        WARN("Primitive mod_constant<simd<double, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<float, sse>> not implemented.");
        CHECK(test_mod_constant_with_modulo_rand<simd<int16_t, sse>>());

        WARN("Primitive mod_constant<simd<int32_t, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<int64_t, sse>> not implemented.");
        CHECK(test_mod_constant_with_modulo_rand<simd<int8_t, sse>>());

        CHECK(test_mod_constant_with_modulo_rand<simd<uint16_t, sse>>());

        WARN("Primitive mod_constant<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive mod_constant<simd<uint64_t, sse>> not implemented.");
        CHECK(test_mod_constant_with_modulo_rand<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'mod_safe' for sse", "[mod_safe],[sse]") {
    using namespace tsl;
    SECTION("with_modulo_one") {
        WARN("Primitive mod_safe<simd<double, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<float, sse>> not implemented.");
        CHECK(test_mod_safe_with_modulo_one<simd<int16_t, sse>>());

        WARN("Primitive mod_safe<simd<int32_t, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<int64_t, sse>> not implemented.");
        CHECK(test_mod_safe_with_modulo_one<simd<int8_t, sse>>());

        CHECK(test_mod_safe_with_modulo_one<simd<uint16_t, sse>>());

        WARN("Primitive mod_safe<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<uint64_t, sse>> not implemented.");
        CHECK(test_mod_safe_with_modulo_one<simd<uint8_t, sse>>());

    }
    SECTION("with_modulo_rand") {
        WARN("Primitive mod_safe<simd<double, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<float, sse>> not implemented.");
        CHECK(test_mod_safe_with_modulo_rand<simd<int16_t, sse>>());

        WARN("Primitive mod_safe<simd<int32_t, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<int64_t, sse>> not implemented.");
        CHECK(test_mod_safe_with_modulo_rand<simd<int8_t, sse>>());

        CHECK(test_mod_safe_with_modulo_rand<simd<uint16_t, sse>>());

        WARN("Primitive mod_safe<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<uint64_t, sse>> not implemented.");
        CHECK(test_mod_safe_with_modulo_rand<simd<uint8_t, sse>>());

    }
    SECTION("check_float_limits") {
        WARN("Primitive mod_safe<simd<double, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<float, sse>> not implemented.");
        CHECK(test_mod_safe_check_float_limits<simd<int16_t, sse>>());

        WARN("Primitive mod_safe<simd<int32_t, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<int64_t, sse>> not implemented.");
        CHECK(test_mod_safe_check_float_limits<simd<int8_t, sse>>());

        CHECK(test_mod_safe_check_float_limits<simd<uint16_t, sse>>());

        WARN("Primitive mod_safe<simd<uint32_t, sse>> not implemented.");
        WARN("Primitive mod_safe<simd<uint64_t, sse>> not implemented.");
        CHECK(test_mod_safe_check_float_limits<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'mul' for sse", "[mul],[sse]") {
    using namespace tsl;
    SECTION("multiply_neg_and_neg") {
        CHECK(test_mul_multiply_neg_and_neg<simd<double, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<float, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<int16_t, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<int32_t, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<int64_t, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<int8_t, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<uint16_t, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<uint32_t, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<uint64_t, sse>>());

        CHECK(test_mul_multiply_neg_and_neg<simd<uint8_t, sse>>());

    }
    SECTION("multiply_neg_and_pos") {
        CHECK(test_mul_multiply_neg_and_pos<simd<double, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<float, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<int16_t, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<int32_t, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<int64_t, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<int8_t, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<uint16_t, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<uint32_t, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<uint64_t, sse>>());

        CHECK(test_mul_multiply_neg_and_pos<simd<uint8_t, sse>>());
    ...
    SECTION("multiply_by_zero") {
        CHECK(test_mul_multiply_by_zero<simd<double, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<float, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<int16_t, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<int32_t, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<int64_t, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<int8_t, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<uint16_t, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<uint32_t, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<uint64_t, sse>>());

        CHECK(test_mul_multiply_by_zero<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'hmax' for sse", "[hmax],[sse]") {
    using namespace tsl;
    SECTION("default") {
        CHECK(test_hmax_default<simd<double, sse>>());

        CHECK(test_hmax_default<simd<float, sse>>());

        CHECK(test_hmax_default<simd<int16_t, sse>>());

        CHECK(test_hmax_default<simd<int32_t, sse>>());

        CHECK(test_hmax_default<simd<int64_t, sse>>());

        CHECK(test_hmax_default<simd<int8_t, sse>>());

        CHECK(test_hmax_default<simd<uint16_t, sse>>());

        CHECK(test_hmax_default<simd<uint32_t, sse>>());

        CHECK(test_hmax_default<simd<uint64_t, sse>>());

        CHECK(test_hmax_default<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'hmin' for sse", "[hmin],[sse]") {
    using namespace tsl;
    SECTION("default") {
        CHECK(test_hmin_default<simd<double, sse>>());

        CHECK(test_hmin_default<simd<float, sse>>());

        CHECK(test_hmin_default<simd<int16_t, sse>>());

        CHECK(test_hmin_default<simd<int32_t, sse>>());

        CHECK(test_hmin_default<simd<int64_t, sse>>());

        CHECK(test_hmin_default<simd<int8_t, sse>>());

        CHECK(test_hmin_default<simd<uint16_t, sse>>());

        CHECK(test_hmin_default<simd<uint32_t, sse>>());

        CHECK(test_hmin_default<simd<uint64_t, sse>>());

        CHECK(test_hmin_default<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'mask_add' for sse", "[mask_add],[sse]") {
    using namespace tsl;
    SECTION("all_one_mask") {
        CHECK(test_mask_add_all_one_mask<simd<double, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<float, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<int16_t, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<int32_t, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<int64_t, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<int8_t, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<uint16_t, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<uint32_t, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<uint64_t, sse>>());

        CHECK(test_mask_add_all_one_mask<simd<uint8_t, sse>>());

    }
    SECTION("zero_mask") {
        CHECK(test_mask_add_zero_mask<simd<double, sse>>());

        CHECK(test_mask_add_zero_mask<simd<float, sse>>());

        CHECK(test_mask_add_zero_mask<simd<int16_t, sse>>());

        CHECK(test_mask_add_zero_mask<simd<int32_t, sse>>());

        CHECK(test_mask_add_zero_mask<simd<int64_t, sse>>());

        CHECK(test_mask_add_zero_mask<simd<int8_t, sse>>());

        CHECK(test_mask_add_zero_mask<simd<uint16_t, sse>>());

        CHECK(test_mask_add_zero_mask<simd<uint32_t, sse>>());

        CHECK(test_mask_add_zero_mask<simd<uint64_t, sse>>());

        CHECK(test_mask_add_zero_mask<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'max' for sse", "[max],[sse]") {
    using namespace tsl;
    SECTION("default") {
        CHECK(test_max_default<simd<double, sse>>());

        CHECK(test_max_default<simd<float, sse>>());

        CHECK(test_max_default<simd<int16_t, sse>>());

        CHECK(test_max_default<simd<int32_t, sse>>());

        CHECK(test_max_default<simd<int64_t, sse>>());

        CHECK(test_max_default<simd<int8_t, sse>>());

        CHECK(test_max_default<simd<uint16_t, sse>>());

        CHECK(test_max_default<simd<uint32_t, sse>>());

        CHECK(test_max_default<simd<uint64_t, sse>>());

        CHECK(test_max_default<simd<uint8_t, sse>>());
...
TEST_CASE("Testing primitive 'min' for sse", "[min],[sse]") {
    ...
    SECTION("min_general_case") {
        ...
        WARN("Primitive min<simd<int32_t, sse>> not implemented.");
        WARN("Primitive min<simd<int64_t, sse>> not implemented.");
        WARN("Primitive min<simd<int8_t, sse>> not implemented.");
        WARN("Primitive min<simd<uint16_t, sse>> not implemented.");
        WARN("Primitive min<simd<uint32_t, sse>> not implemented.");
