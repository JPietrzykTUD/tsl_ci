...
/*
 * \file /home/jpietrzyk/tmp/TSL_ACTIONS/tsl_ci/sse_only/src/test/convert_unit_test.cpp
 * \date 2024-02-29
...
TEST_CASE("Testing primitive 'cast' for sse", "[cast],[sse]") {
    using namespace tsl;
    SECTION("default_int_float_conversion") {
        WARN("Primitive cast<simd<double, sse>> not implemented.");
        WARN("Primitive cast<simd<float, sse>> not implemented.");
        WARN("Primitive cast<simd<int16_t, sse>> not implemented.");
        CHECK(test_cast_default_int_float_conversion<simd<int32_t, sse>, simd<float, sse>>());

        WARN("Primitive cast<simd<int64_t, sse>> not implemented.");
        WARN("Primitive cast<simd<int8_t, sse>> not implemented.");
        WARN("Primitive cast<simd<uint16_t, sse>> not implemented.");
        CHECK(test_cast_default_int_float_conversion<simd<uint32_t, sse>, simd<float, sse>>());

        WARN("Primitive cast<simd<uint64_t, sse>> not implemented.");
        WARN("Primitive cast<simd<uint8_t, sse>> not implemented.");
    }
}
