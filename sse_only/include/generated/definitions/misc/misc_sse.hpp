 ...
 *==========================================================================*/
/*
 * \file /home/jpietrzyk/tmp/TSL_ACTIONS/tsl_ci/sse_only/include/generated/definitions/misc/misc_sse.hpp
 * \date 2024-02-29
 ...
 *
 */
#ifndef TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_SSE_ONLY_INCLUDE_GENERATED_DEFINITIONS_MISC_MISC_SSE_HPP
#define TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_SSE_ONLY_INCLUDE_GENERATED_DEFINITIONS_MISC_MISC_SSE_HPP
...
namespace tsl {
    ...
    namespace functors {
         ...
         *      Yaml Source: primitive_data/primitives/misc.yaml::96
         */
    ...
    namespace functors {
         ...
         *        Data Type: uint8_t
         *  Extension Flags: ['sse2']
         *      Yaml Source: primitive_data/primitives/misc.yaml::282
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: uint8_t
         *  Extension Flags: ['sse2']
         *      Yaml Source: primitive_data/primitives/misc.yaml::389
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: uint8_t
         *  Extension Flags: ['sse2']
         *      Yaml Source: primitive_data/primitives/misc.yaml::475
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *      Yaml Source: primitive_data/primitives/misc.yaml::479
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: uint8_t
         *  Extension Flags: ['sse2']
         *      Yaml Source: primitive_data/primitives/misc.yaml::529
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: float
         *  Extension Flags: ['sse', 'sse2']
         *      Yaml Source: primitive_data/primitives/misc.yaml::533
         */
        template<ImplementationDegreeOfFreedom Idof>
    ...
    namespace functors {
         ...
         *        Data Type: uint8_t
         *  Extension Flags: ['sse2']
         *      Yaml Source: primitive_data/primitives/misc.yaml::622
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<uint8_t, sse>, Idof> {
            using Vec = simd<uint8_t, sse>;
            ...
            static typename Vec::register_type apply(
                ...
                return _mm_and_si128(tsl::to_mask<Vec>(mask), src);
            }
        };
    } // end of namespace functors for template specialization of imaskz_mov for sse using uint8_t.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<uint16_t, sse>, Idof> {
            using Vec = simd<uint16_t, sse>;
    ...
    } // end of namespace functors for template specialization of imaskz_mov for sse using uint16_t.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<int8_t, sse>, Idof> {
            using Vec = simd<int8_t, sse>;
    ...
    } // end of namespace functors for template specialization of imaskz_mov for sse using int8_t.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<int16_t, sse>, Idof> {
            using Vec = simd<int16_t, sse>;
    ...
    } // end of namespace functors for template specialization of imaskz_mov for sse using int16_t.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<uint32_t, sse>, Idof> {
            using Vec = simd<uint32_t, sse>;
    ...
    } // end of namespace functors for template specialization of imaskz_mov for sse using uint32_t.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<int32_t, sse>, Idof> {
            using Vec = simd<int32_t, sse>;
    ...
    } // end of namespace functors for template specialization of imaskz_mov for sse using int32_t.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<uint64_t, sse>, Idof> {
            using Vec = simd<uint64_t, sse>;
    ...
    } // end of namespace functors for template specialization of imaskz_mov for sse using uint64_t.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<int64_t, sse>, Idof> {
            using Vec = simd<int64_t, sse>;
    ...
    } // end of namespace functors for template specialization of imaskz_mov for sse using int64_t.
    ...
    namespace functors {
         ...
         *        Data Type: float
         *  Extension Flags: ['sse', 'sse2']
         *      Yaml Source: primitive_data/primitives/misc.yaml::626
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<float, sse>, Idof> {
            using Vec = simd<float, sse>;
            ...
            static typename Vec::register_type apply(
                ...
                return _mm_and_ps(tsl::to_mask<Vec>(mask), src);
            }
        };
    } // end of namespace functors for template specialization of imaskz_mov for sse using float.
    ...
    namespace functors {
         ...
         */
        template<ImplementationDegreeOfFreedom Idof>
        struct imaskz_mov<simd<double, sse>, Idof> {
            using Vec = simd<double, sse>;
            ...
            static typename Vec::register_type apply(
                ...
                return _mm_and_pd(tsl::to_mask<Vec>(mask), src);
            }
        };
    } // end of namespace functors for template specialization of imaskz_mov for sse using double.

} // end of namespace tsl
#endif //TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_SSE_ONLY_INCLUDE_GENERATED_DEFINITIONS_MISC_MISC_SSE_HPP