 ...
 *==========================================================================*/
/*
 * \file /home/jpietrzyk/tmp/TSL_ACTIONS/tsl_ci/sse_only/include/generated/declarations/mask.hpp
 * \date 2024-02-29
 ...
 *
 */
#ifndef TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_SSE_ONLY_INCLUDE_GENERATED_DECLARATIONS_MASK_HPP
#define TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_SSE_ONLY_INCLUDE_GENERATED_DECLARATIONS_MASK_HPP
...
namespace tsl {
    ...
    [[nodiscard]] TSL_FORCE_INLINE auto mask_binary_or(
      ...
      !tsl_primitive_ambiguous<functors::mask_binary_or<Vec, Idof>, functors::imask_binary_or<Vec, Idof>>(),
    #else
      true,
    #endif
      typename Vec::imask_type
    ...
    [[nodiscard]] TSL_FORCE_INLINE auto mask_binary_xor(
      ...
      !tsl_primitive_ambiguous<functors::mask_binary_xor<Vec, Idof>, functors::imask_binary_xor<Vec, Idof>>(),
    #else
      true,
    #endif
      typename Vec::imask_type
...
#endif //TUD_D2RG_TSL_HOME_JPIETRZYK_TMP_TSL_ACTIONS_TSL_CI_SSE_ONLY_INCLUDE_GENERATED_DECLARATIONS_MASK_HPP